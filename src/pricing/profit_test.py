...
def model_point_label(model_point: ModelPoint) -> str:
    ...
    """
    if model_point.model_point_id:
        return model_point.model_point_id
    return (
...
def _parse_model_points(config: Mapping[str, object]) -> list[ModelPoint]:
    ...
    for entry in points_cfg:
        ...
        points.append(
            ModelPoint(
                model_point_id=str(model_point_id) if model_point_id is not None else None,
                issue_age=issue_age,
                sex=sex,
                term_years=term_years,
                premium_paying_years=premium_paying_years,
