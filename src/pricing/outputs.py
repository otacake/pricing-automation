...
def write_optimize_log(
    ...
    lines = [
        ...
        f"premium_to_maturity_soft_min: {settings.premium_to_maturity_soft_min}",
        f"nbv_hard: {settings.nbv_hard}",
        f"l2_lambda: {settings.l2_lambda}",
        f"objective_mode: {settings.objective_mode}",
        f"min_irr: {result.min_irr}",
        f"min_irr_model_point: {result.min_irr_model_point}",
