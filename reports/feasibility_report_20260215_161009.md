# 実現可能性レポート (trial-001.optimized_20260215_161009.yaml, 生成日 2026-02-15)

## サマリー
- 制約違反件数: `violation_count=0` / `7` モデルポイント。
- 収益性下限: `min_irr=0.068760`。
...
|IRR荳矩剞|0.068760|male_age30_term35|適合|
|loading_positive|15215.000000|female_age30_term35|適合|
|雋闕ｷ菴吝臆荳矩剞|97579.972666|female_age30_term35|適合|
|雋闕ｷ菴吝臆邇・ｸ矩剞|0.032527|female_age30_term35|適合|
|NBV荳矩剞|78837.197195|female_age60_term10|適合|
|PTM荳企剞|-0.019947|male_age50_term20|要対応|

## Loading式と係数
- `gross_rate = (net_rate + alpha / a + beta) / (1 - gamma)`
- loadingモード: `loading_parameters`。
|coefficient|value|
|---|---:|
|a0|0.006000|
|a_age|0.000000|
...
## 年度別キャッシュフロー（利源別）
![年度別キャッシュフロー（利源別）](../out/charts/executive/20260215_161009/cashflow_by_profit_source.png)

![モデルポイント別 年間保険料](../out/charts/executive/20260215_161009/annual_premium_by_model_point.png)

## 感応度サマリー
|scenario|min_irr|min_nbv|min_loading_surplus_ratio|max_premium_to_maturity|violation_count|
|---|---:|---:|---:|---:|---:|
|繝吶・繧ｹ|0.068760|78837.20|-0.067473|1.069947|0|
|驥大茜-10%|0.072045|90980.95|-0.067336|1.079573|3|
|驥大茜+10%|0.065556|66756.61|-0.067606|1.060407|0|
|隗｣邏・紫-10%|0.071295|80240.64|-0.067620|1.069947|0|
|隗｣邏・紫+10%|0.066224|77443.64|-0.067334|1.069947|0|
|莠区･ｭ雋ｻ-10%|0.079657|111373.02|-0.053308|1.069947|0|
|莠区･ｭ雋ｻ+10%|0.054733|46301.37|-0.081638|1.069947|0|
...
```powershell
python -m pytest -q
python -m pricing.cli run C:/Users/shunsuke/pricing-automation/out/trial-001.optimized_20260215_161009.yaml
python -m pricing.cli report-feasibility C:/Users/shunsuke/pricing-automation/out/trial-001.optimized_20260215_161009.yaml --r-start 1.00 --r-end 1.08 --r-step 0.005 --irr-threshold 0.02 --out out/feasibility_deck_executive.yaml
python -m pricing.cli report-executive-pptx C:/Users/shunsuke/pricing-automation/out/trial-001.optimized_20260215_161009.yaml --out reports/executive_pricing_deck.pptx --md-out reports/feasibility_report.md --lang ja
```