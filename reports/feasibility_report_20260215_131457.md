# 実現可能性レポート (trial-001.optimized_20260215_131457.yaml, 生成日 2026-02-15)
...
```powershell
python -m pytest -q
python -m pricing.cli run C:/Users/shunsuke/pricing-automation/out/trial-001.optimized_20260215_131457.yaml
python -m pricing.cli report-feasibility C:/Users/shunsuke/pricing-automation/out/trial-001.optimized_20260215_131457.yaml --r-start 1.00 --r-end 1.08 --r-step 0.005 --irr-threshold 0.02 --out out/feasibility_deck_executive.yaml
python -m pricing.cli report-executive-pptx C:/Users/shunsuke/pricing-automation/out/trial-001.optimized_20260215_131457.yaml --out reports/executive_pricing_deck.pptx --md-out reports/feasibility_report.md --lang ja
```