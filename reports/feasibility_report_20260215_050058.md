# 実現可能性レポート (trial-001.optimized_20260215_050058.yaml, 作成日 2026-02-15)
...
## 年度別キャッシュフロー（利源別）
![年度別キャッシュフロー（利源別）](../out/charts/executive/20260215_050058/cashflow_by_profit_source.png)

![モデルポイント別 年払保険料](../out/charts/executive/20260215_050058/annual_premium_by_model_point.png)
...
```powershell
python -m pytest -q
python -m pricing.cli run C:/Users/shunsuke/pricing-automation/out/trial-001.optimized_20260215_050058.yaml
python -m pricing.cli report-feasibility C:/Users/shunsuke/pricing-automation/out/trial-001.optimized_20260215_050058.yaml --r-start 1.00 --r-end 1.08 --r-step 0.005 --irr-threshold 0.02 --out out/feasibility_deck_executive.yaml
python -m pricing.cli report-executive-pptx C:/Users/shunsuke/pricing-automation/out/trial-001.optimized_20260215_050058.yaml --out reports/executive_pricing_deck.pptx --md-out reports/feasibility_report.md --lang ja
```